...
public:
    ...
    void printType()const override  { 
        cout << "<<Animal>>" << endl;
        cout << "Number of legs: " << numberOfLegs << ", gender: " << gender << ", family: "<<family<< ", breed: " << breed <<", size: " << size <<endl<<endl;
   }
...
public:
    ...
    void printType()const override {
        ...
        cout<< "name: "<< name<<", age: "<< age <<", eyeColor: "<< eyeColor<<", skinColor: "<< skinColor<<", race: "<< race<<", profession: "<<profession<<endl<<endl;
        }
...
public:
    ...
    cout<< "size: " << size <<", Type: " << Type << ", color: "<< color<<endl<<endl;
    }
...
public:
    ...
    void printType()const override { 
        cout << "<<Gas>>" << endl;
        cout<<"Density: " << density<<", smell: " << smell<<endl<<endl;
    }
};
...
public:
    ...
    void printType()const override {
         cout << "<<Liquid>>" << endl;
         cout<<"Density: " << density<<", taste: " << taste<<endl<<endl;
    }
};
